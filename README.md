...
- 네이버 검색 API 결과는 기본 최대 1,000위까지 확인
- 다수 업체 / 다수 키워드 일괄 점검
- 검색 결과 캡처 저장
- 점검 결과 엑셀 리포트 자동 생성
- 블로그 글 누락 여부 확인
...
- `식별값`에는 블로그 ID(`soso2226`) 또는 전체 주소(`https://blog.naver.com/soso2226`)를 권장합니다. 기존 업체명 식별값도 계속 사용할 수 있습니다.
- 보고서 템플릿에서 키워드를 불러올 때 업체명과 별도로 블로그 식별값을 입력할 수 있습니다.
